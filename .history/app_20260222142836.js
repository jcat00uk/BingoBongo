...
function toggleWinTextVisibility() {
    if (autoCheckToggle.checked) {
        winText.textContent = 'No Win'; // Set default text if autoCheckToggle is on (or any desired text)
    } else {
        winText.textContent = ''; // Clear text inside winText if autoCheckToggle is off
    }
}
