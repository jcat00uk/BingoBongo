...
function populateCardList(filter='') {
  ...
  sortedCards.forEach(c => {
    ...
    topRow.style.display = 'flex';
    topRow.style.alignItems = 'center';
    topRow.style.justifyContent = 'space-between'; // keeps preview button on far right
    topRow.style.gap = '6px';
...
leftGroup.style.gap = '6px'; // space between checkbox and card code

leftGroup.appendChild(checkbox);
leftGroup.appendChild(span); // card code next to checkbox
    ...
    topRow.appendChild(leftGroup); // left side: checkbox + code
    topRow.appendChild(infoBtn);   // right side: preview button
