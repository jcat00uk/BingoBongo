...
// Only scroll if the search box has a value
if (cardSearchBox && cardSearchBox.value.trim() !== '') {
    ...
    if (selectedCardsInDOM.length > 0) {
        ...
        // Scroll the modal container so the last selected card is visible at the bottom
        modalCardList.scrollTop = lastSelected.offsetTop + lastSelected.offsetHeight - modalCardList.clientHeight;
    }
}
