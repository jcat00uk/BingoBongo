...
newGameBtn.onclick = () => {
  cardSelectionWrapper.style.display = 'flex'; // show modal
  tempSelection = [];                          // reset temporary selection
  populateCardList();                          // render cards
  newGameBtn.disabled = true;                  // disable until game ends
  endGameBtn.disabled = false;
};
