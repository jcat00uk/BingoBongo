...
function handleModalCardClick(code) {
  ...
  // Flash animation
  cardDiv.classList.add(isSelected ? 'flash-deselect' : 'flash-select');
  setTimeout(() => cardDiv.classList.remove('flash-select', 'flash-deselect'), 400);
  ...
  // **Re-render the list so selected cards move to top**
  renderModalCardList();
